  ...
  module Plugin
    module Gallery
      module Helpers
        ...
        # default config
        WIDTH_RESOLUTIONS_DEFAULT = Array.[](320, 640, 800, 960, 1024, 1152, 1280, 1366, 1680, 1920)
        HEIGHT_RESOLUTIONS_DEFAULT = Array.[](200, 480, 600, 540, 768, 720, 800, 768, 1050, 1080)
